...
MAINHUB.Name = "Blox Fruits Hub"
MAINHUB.Parent = game.CoreGui
MAINHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling


do local GUI = game.CoreGui:FindFirstChild("Blox Fruits Hub");if GUI then GUI:Destroy();end;if _G.Color == Color3.fromRGB(255, 255, 255) then
...
function Update:Window(text,logo,keybind)
	...
	local logo = logo
	local currentpage = ""
	local keybind = keybind or Enum.KeyCode.RightShift
	local yoo = string.gsub(tostring(keybind),"Enum.KeyCode.","")
	
	local MAINHUB2 = Instance.new("ScreenGui")
	MAINHUB2.Name = "Blox Fruits Hub"
	MAINHUB2.Parent = game.CoreGui
	MAINHUB2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = MAINHUB2
...
local games = {
   [game.PlaceId] = {
      ...
      Icons = "",
      Welcome = function()
            return tostring("Blox Fruits Hub Loadded")
      end
   }
}
...
local Library = Update:Window("Blox Fruits","",Enum.KeyCode.RightShift);
...
local logs = game:HttpGetAsync("https://pastebin.com/raw/EA3XheHW")

main:Label("Welcome "..game.Players.LocalPlayer.DisplayName.. " To Blox Fruits Hub")
...
function UpdateTime()
    ...
    Time:Set("Time Spent : "..Hour.." Minutes : "..Minute.." Seconds : "..Second)
end
...
iain:Seperator("Worlds")
    ...
    elseif World3 then
        iain:Toggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
...
_G.Ore = false
    iain:Toggle("Auto Dragon Scale (Sea 3)",_G.DragonScale,function(value)
        ...
        while wait() do
		 ...
		 iain:Toggle("Auto Fish Tails (Sea 1)",_G.FishTails,function(value)
        _G.FishTails = value
    end)
	    spawn(function()
        while wait() do
            if _G.FishTails then
			 ...
			 iain:Toggle("Auto Ore (Sea 1)",_G.Ore,function(value)
        _G.Ore = value
    end)
	    spawn(function()
        while wait() do
...
Misc:Button("Color Haki",function()
    ...
    Misc:Button("Unlock FPS",function()
     ...
     Misc:Button("Fake Skin MODEÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¾ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
